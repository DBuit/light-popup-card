      ...
      <div class="${fullscreen === true ? 'popup-wrapper' : ''}">
            <div class="popup-inner" @click="${e => this._close(e)}">
                ...
                ${stateObj.attributes.supported_features > supportedFeaturesTreshold ? html `
                    <h4 class="${stateObj.state === "off" ? '' : 'brightness'}">${stateObj.state === "off" ? b(this.hass.localize, stateObj, this.hass.language) : Math.round(stateObj.attributes.brightness / 2.55)}</h4>
