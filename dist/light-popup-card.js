      ...
      <div class="${!0===u?"popup-wrapper":""}">
            <div id="popup" class="popup-inner" @click="${t=>this._close(t)}">
                ...
                <div class="action-holder">
                    ...
                    ${this.actionRows.map(t=>{S++;var e=0;return T`
                        <div class="action-row">
                        ${t.map(t=>(e++,T`
                            <div class="action" style="--size:${o};" @click="${t=>this._activateAction(t)}" data-service="${S}#${e}">
                                <span class="color" style="background-color: ${t.color};border-color: ${t.color};--size:${o};">${t.icon?T`<ha-icon icon="${t.icon}" />`:T``}</span>
                ...
                ${this.settings?T`<button class="settings-btn ${this.settingsPosition}${!0===u?" fullscreen":""}" @click="${()=>this._openSettings()}">${this.config.settings.openButton?this.config.settings.openButton:"Settings"}</button>`:T``}
            </div>
