            ...
            <div class="popup-inner" @click="${t=>this._close(t)}">
                ...
                ${e.attributes.supported_features>s?F`
                    ...
                    <div class="range-holder" style="--slider-height: ${f};--slider-width: ${p};">
                        <input type="range" style="--slider-width: ${p};--slider-height: ${f}; --slider-border-radius: ${i}" .value="${"off"===e.state?0:Math.round(e.attributes.brightness/2.55)}" @change=${t=>this._setBrightness(e,t.target.value)}>
                    </div>
                `:F`
                    <h4>${Bt(this.hass.localize,e,this.hass.language)}</h4>
                    <div class="switch-holder" style="--switch-height: ${m};--switch-width: ${g};">
                        <input type="range" style="--switch-width: ${g};--switch-height: ${m}; --slider-border-radius: ${i}" value="0" min="0" max="1" .value="${u}" @change=${()=>this._switch(e)}>
                    </div>
                `}
